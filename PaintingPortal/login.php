...
if(isset($_POST['login'])) {
    // Get and prepare login credentials
    $email = $_POST['email'];
...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO users(name,email,contactNo,password,billingAddress,shippingAddress) VALUES('$name','$email','$contactno','$password','$billingaddress','$shippingaddress')";
    $result = mysqli_query($con, $sql);
